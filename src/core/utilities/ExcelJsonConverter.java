...
public class ExcelJsonConverter 
{
	...
	public String createExcelFileStructure (String filename)
	{
		...
		try
		{
			...
			JSONObject json = new JSONObject(FileLib.ReadContentOfFile(filename).toString());
	...
	public String json2Excel(String filename)
	{
		...
		System.out.println(FileLib.ReadContentOfFile(filename).toString());
		try
		{
			/** create json object from supplied json file */
			JSONObject jsonObject = null;
			jsonObject = new JSONObject(FileLib.ReadContentOfFile(filename).toString());
